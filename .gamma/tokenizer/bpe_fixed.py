#!/usr/bin/env python3
"""Tokenizador BPE mínimo sin regex complejos"""
import json
...
class MinimalBPETokenizer:
    ...
    def train(self, text):
        ...
        print(f"✓ Vocabulario entrenado: {len(self.vocab)} tokens")
    ...
    def save(self, path):
        ...
        print(f"✓ Tokenizador guardado: {path}")
...
if __name__ == "__main__":
    ...
    corpus = "the fox jumps " * 100  # Corpus de prueba
    ...
    tokenizer.save('tokenizer/bpe_vocab.json')
